...
"""
FastAPI application for the Smart Traffic Env Environment.

This module creates an HTTP server that exposes the SmartTrafficEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn smart_traffic_env.server.app:app --workers 4
    """
    import uvicorn
